...
window.onload = function() {
    ...
    setTimeout(function() {
        const headerChildren = document.querySelector('.header-main-external-links');
...
function hMELMouseEnter(num) {
    const hMELListItem = document.querySelector(`#js-header-main-external-links-list-item-${num}`);
    hMELListItem.style.borderRadius = "100%";
    hMELListItem.style.marginBottom = "15px";
    hMELListItem.style.cursor = "pointer";
    if (num === 1) {
        hMELListItem.style.boxShadow = "0 0 0.5em var(--color-apple), 0 0 1em var(--color-apple)";
    } else if (num === 2) {
        hMELListItem.style.boxShadow = "0 0 0.5em var(--color-spotify), 0 0 1em var(--color-spotify)";
    } else if (num === 3) {
        hMELListItem.style.boxShadow = "0 0 0.5em var(--color-tidal), 0 0 1em var(--color-tidal)";
    } else if (num === 4) {
        hMELListItem.style.boxShadow = "0 0 0.5em var(--color-amazon), 0 0 1em var(--color-amazon)";
    } else if (num === 5) {
        hMELListItem.style.boxShadow = "0 0 0.5em var(--color-youtube), 0 0 1em var(--color-youtube)";
    } else if (num === 6) {
        hMELListItem.style.boxShadow = "0 0 0.5em var(--color-soundcloud), 0 0 1em var(--color-soundcloud)";
    }
